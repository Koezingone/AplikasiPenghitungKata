...
public class PenghitungKataFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "APLIKASI PENGHITUNG KATA", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Segoe UI", 3, 18), new java.awt.Color(255, 153, 153))); // NOI18N
        ...
        jLabel1.setText("TULIS KATA / KALIMAT :");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE))
    ...
    if (searchText.isEmpty()) {
        jLabel7.setText("HASIL PENCARIAN KATA: 0 kata ditemukan");
        return;
    }

    Pattern pattern = Pattern.compile("\\b" + Pattern.quote(searchText) + "\\b");
    ...
    jLabel7.setText("HASIL PENCARIAN KATA: " + count + " kata ditemukan");
    }

    private void saveToFile() {
        String text = jTextArea1.getText();
    if (text.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Teks kosong, tidak ada data untuk disimpan.");
        return;
    }
    
    String result = String.format(
        "Jumlah Karakter: %s%nJumlah Kata: %s%nJumlah Kalimat: %s%nJumlah Paragraf: %s%n%s",
        jLabel2.getText(),
        jLabel3.getText(),
        jLabel4.getText(),
        jLabel5.getText(),
        jLabel7.getText() // Menampilkan hasil pencarian kata
    );
